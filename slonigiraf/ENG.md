...
Each **diploma** is a unique electronic document, that can be canceled in any time if a tutee will show it to an expert and the expert will say that the tutee doesn't posses the skill. The expert gets a **reimbursement** for identifying a fake diploma. The reimbursement is paid by the tutor who issued such diploma. The amount of reimbursement is defined at the stage of diploma issuing. Thus each diploma contains the information: which skill was trained, who was a tutor, who was a tutee and what is an amount of the possible reimbursement.
